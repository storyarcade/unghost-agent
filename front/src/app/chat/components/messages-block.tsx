                ...
                {!replayHasError && (
                  <div className="pr-4">
                    {responding && (
                      <Button
                        className={cn(
                          "min-w-[140px] transition-all duration-300 group",
                          fastForwarding && "animate-pulse shadow-2xl scale-105"
                        )}
                        variant={fastForwarding ? "agentic" : "agentic-outline"}
                        onClick={handleFastForwardReplay}
                      >
                        <FastForward size={18} className={cn(
                          "mr-1 transition-transform",
                          fastForwarding && "animate-spin"
                        )} />
                        Fast Forward
                      </Button>
                    )}
                    {!replayStarted && (
                      <Button 
                        className="min-w-[120px] shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 group" 
                        variant="agentic"
                        onClick={handleStartReplay}
                      >
                        <Play size={18} className="mr-1 group-hover:translate-x-1 transition-transform" />
                        Play
                      </Button>
                    )}
                  </div>
